    ...
    bindHomeLink: function() {
        ...
        $(this.classes.homeLinkClass).hammer().bind('tap', function(e) {
            return setTimeout((function() {
                ...
                if (typeof self.config.sections[0].slides[0].alias != 'undefined') {
                    homeSlide = self.config.sections[0].slides[0].alias;
                } else {
                    homeSlide = self.config.sections[0].slides[0].name;
                }
                return CommunicateEmbedded.navigate(homeSlide);
            }), 190);
        });
    },
